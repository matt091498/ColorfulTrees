...
public class CTItemModels extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        withExistingParent(Registration.BLACK_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/black_oak_planks"));
        withExistingParent(Registration.RED_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/red_oak_planks"));
        withExistingParent(Registration.GREEN_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/green_oak_planks"));
        withExistingParent(Registration.BROWN_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/brown_oak_planks"));
        withExistingParent(Registration.BLUE_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/blue_oak_planks"));
        withExistingParent(Registration.PURPLE_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/purple_oak_planks"));
        withExistingParent(Registration.CYAN_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/cyan_oak_planks"));
        withExistingParent(Registration.LIGHT_GRAY_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/light_gray_oak_planks"));
        withExistingParent(Registration.GRAY_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/gray_oak_planks"));
        withExistingParent(Registration.PINK_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/pink_oak_planks"));
        withExistingParent(Registration.LIME_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/lime_oak_planks"));
        withExistingParent(Registration.YELLOW_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/yellow_oak_planks"));
        withExistingParent(Registration.LIGHT_BLUE_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/light_blue_oak_planks"));
        withExistingParent(Registration.MAGENTA_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/magenta_oak_planks"));
        withExistingParent(Registration.ORANGE_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/orange_oak_planks"));
        withExistingParent(Registration.WHITE_STAIRS_ITEM.get().getRegistryName().getPath(), modLoc("block/white_oak_planks"));
